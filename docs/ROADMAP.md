...
| 18 | **Time range** — 24 hours, 7 days, 30 days, and what the store can actually cover (§4.43) | S6 | 🔨 built 2026-09-14 · **awaiting router test** |
| 19 | Drill-down everywhere: a segment opens its devices, an hour opens its addresses (BACKLOG #22) | S6 | ⏳ |
